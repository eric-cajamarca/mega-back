...
//productos
api.get('/listar_productos_publico/:filtro?',clienteController.listar_productos_publico);
api.get('/listar_productos_categoria_publico/:filtro?',clienteController.listar_productos_categoria_publico);
